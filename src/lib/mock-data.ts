...
export const events: Event[] = [
  ...
  {
    id: 'e14',
    title: 'OC Wine & Jazz Festival',
    description:
      'An evening of world-class jazz and curated wine pairings from 12 local vineyards. VIP includes early entry, reserved seating, and a souvenir wine glass.',
    date: daysFromNow(21, 17, 0),
    time: '5:00 PM',
    location: {
      name: 'Irvine Amphitheatre',
      address: '100 Civic Center Dr, Irvine, CA 92606',
      lat: 33.6846,
      lng: -117.8265,
    },
    category: EventCategory.FoodDrink,
    ...
    ticketTiers: [
      {
        ...
        description: 'Access to all stages and food vendors',
        priceInCents: 4500,
        soldCount: 180,
        sortOrder: 0,
        isPopular: true,
        perks: ['All-stage access', 'Food vendor access', '2 drink tickets'],
      },
      {
        id: 'tier-14-vip',
        eventId: 'e14',
        ...
        priceInCents: 8500,
        originalPriceInCents: 9500,
        capacity: 100,
        soldCount: 54,
        sortOrder: 1,
        isPopular: false,
        perks: ['Early entry (4 PM)', 'Reserved front seating', 'Unlimited drink tickets', 'Souvenir wine glass', 'Meet & greet with artists'],
      },
    ],
    isRecurring: false,
    friendsGoing: [users[1], users[3]],
    friendsInterested: [users[0], users[5], users[7]],
  },

  // -- FREE WITH UPSELL EVENT --
  {
    id: 'e15',
    title: 'Laguna Beach Sunrise Bootcamp',
    description:
      'Free outdoor bootcamp on the beach. All fitness levels welcome. Optional add-ons include a post-workout smoothie bar and a branded performance towel.',
    date: daysFromNow(8, 6, 0),
    time: '6:00 AM',
    location: {
      name: 'Main Beach, Laguna Beach',
    ...
    host: hosts[1],
    pricingType: 'free_with_upsell' as const,
    ticketTiers: [
      {
        id: 'tier-15-smoothie',
        eventId: 'e15',
        name: 'Post-Workout Smoothie',
        description: 'Fresh smoothie from the beachside bar',
        priceInCents: 800,
        soldCount: 12,
        sortOrder: 0,
        isPopular: true,
        perks: ['Choice of 5 flavors', 'Protein boost included'],
      },
      {
        id: 'tier-15-towel',
        eventId: 'e15',
        name: 'Branded Performance Towel',
        description: 'Quick-dry microfiber towel with bootcamp branding',
        priceInCents: 1500,
        soldCount: 8,
        sortOrder: 1,
        isPopular: false,
        perks: ['Premium microfiber', 'Exclusive design'],
      },
    ],
    isRecurring: false,
    friendsGoing: [users[0], users[2]],
    friendsInterested: [users[4]],
  },
  ...
  {
    id: 'e16',
    title: 'Pottery & Pinot Night',
    description:
      'Create your own ceramic piece while sipping local wines. All materials included. Your finished piece will be kiln-fired and ready for pickup in 2 weeks.',
    ...
    ticketTiers: [
      {
        ...
        eventId: 'e16',
        name: 'Standard',
        description: 'Pottery session + 2 glasses of wine',
        priceInCents: 6500,
        capacity: 12,
        soldCount: 10,
        sortOrder: 0,
        isPopular: true,
        perks: ['All materials included', '2 wine pours', 'Kiln firing & glazing'],
      },
      {
        id: 'tier-16-couples',
        eventId: 'e16',
        name: 'Couples Package',
        description: 'Two seats + bottle of wine',
        priceInCents: 11000,
        ...
        sortOrder: 1,
        isPopular: false,
        perks: ['2 pottery sessions', 'Full bottle of wine', 'Side-by-side seating', 'Photo keepsake'],
      },
    ],
    isRecurring: false,
    friendsGoing: [users[5]],
    friendsInterested: [users[1], users[7]],
  },
];
